(function($){
    ...
    var settings = $.extend({
			...
			tpl: {
				...
				overview:		'<div id="feedback-overview"><div class="feedback-logo"><i class="fa fa-comments" aria-hidden="true"></i> 反馈/建议</div><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>反馈内容</h3><h3 class="feedback-additional">联系方式(邮箱)</h3><div id="feedback-email"><input name="fb-email"type="text"class="fb-email"maxlength="100"placeholder="请留下您的联系方式，以便我们及时回复您。"id="fb-email"></div></div></div><div id="feedback-overview-screenshot"><h3>截图</h3></div><div class="feedback-buttons"><button id="feedback-submit"class="feedback-submit-btn feedback-btn-blue">提交</button><button id="feedback-overview-back"class="feedback-back-btn feedback-btn-gray">返回</button></div><div id="feedback-overview-error">请输入内容！</div><div class="feedback-wizard-close"></div></div>',
